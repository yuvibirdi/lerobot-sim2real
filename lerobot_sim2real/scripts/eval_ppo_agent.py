...
if __name__ == "__main__":
    ...
    eval_envs.agent.controller._target_qpos[:, :] = sim_env_test.agent.controller._target_qpos[:, :]
            ...
            with torch.no_grad():
                ...
                if args.debug:
                    ...
                    if not hasattr(plt, "comparison_fig"):
                        plt.comparison_fig, (plt.ax1, plt.ax2, plt.ax3, plt.ax4) = plt.subplots(
                            1, 4, figsize=(10, 6)
                        )
                    ...
                    for key in raw_sim_obs["extra"].keys():
                        ...
                        print(f"    diff: {raw_sim_obs['extra'][key].float() - raw_real_obs['extra'][key].float()}")
